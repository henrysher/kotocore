...
from kotocore.collections import ResourceJSONLoader, CollectionDetails
from kotocore.collections import Collection, CollectionFactory
from kotocore.resources import Resource, ResourceDetails
